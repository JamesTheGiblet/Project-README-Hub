...
2. **Compare** to a threshold
3. **Act** to maintain existence
4. **Repeat**
...
### Atmospheric Agents (Light Blue/Purple)
...
1. Agents sense their environment
2. Agents compare to internal thresholds
3. Agents act to maintain those thresholds
4. Complex behavior emerges from collective action
...
Every agent - heat, water, pressure, life, storm - runs this same loop.
